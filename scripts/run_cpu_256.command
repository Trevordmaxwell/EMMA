#!/bin/bash
# Run EMMA (CPU-friendly) len=256 config locally from the reorganized workspace.
set -euo pipefail
...
LOG="$LOG_DIR/cpu_len256.log"
CSV="$LOG_DIR/cpu_len256_per_epoch.csv"
CFG="$PROJECT_ROOT/configs/cpu_len256.yaml"
SAVE_CFG="$LOG_DIR/configs/cpu_len256.yaml"
cd "$PROJECT_ROOT"
...
log_path = project_root / 'experiments' / 'runs' / 'cpu_len256.log'
metrics = {}
if log_path.exists():
    for line in log_path.read_text(encoding='utf-8', errors='ignore').splitlines():
        ...
        if line.startswith('METRIC '):
            try:
                ...
                pass
result_path = project_root / 'experiments' / 'results' / 'cpu_len256_metrics.json'
